...
class Worker(WorkerBase):
    ...
    def eldr_capture(self, mode: str, core_pid: int, prefix_reset: bool):
        from vllm.eldr.control import worker_capture

        return worker_capture(self, mode, core_pid, prefix_reset)
