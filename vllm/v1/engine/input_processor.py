...
class InputProcessor:
    ...
    def process_inputs(
        ...
        if isinstance(params, SamplingParams):
            ...
            from vllm.eldr.prefill_first import validate as validate_prefill_first

            validate_prefill_first(
                self.vllm_config, sampling_params, prompt_token_ids, prompt_embeds
            )
        else:
