...
class ModelRunnerOutput:
    ...
    # Final-prefill count bytes, transported with this step (opt-in ELDR).
    # None leaves the legacy path unchanged; no tensor crosses process IPC.
    eldr_signatures: dict[str, bytes] | None = None
